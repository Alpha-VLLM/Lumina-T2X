...
def model_main(args, master_port, rank, request_queue, response_queue, mp_barrier):
    ...
    while True:
        ...
        z = torch.randn([1, 4, latent_h, latent_w], device="cuda")
        z = z.repeat(2, 1, 1, 1)
...
**ema**: {args.ema}"""
        ...
        def on_submit(caption, resolution, num_sampling_steps, cfg_scale, solver):
            for q in request_queues:
                q.put((caption, resolution, num_sampling_steps, cfg_scale, solver))
