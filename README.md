...
- **[2024-05-29] 🥰🥰🥰 We released 2K Resolution inference code and Time-aware Scaled RoPE. Besides, we released the new model with higher quality generation. [HF Model](https://huggingface.co/Alpha-VLLM/Lumina-Next-T2I/tree/main)**
